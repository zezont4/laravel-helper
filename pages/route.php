...
<div class="clearfix col-xs-12">
	<hr>
	<?php $filePath = $outputDir . $edited_table_name . "route"; ?>
	<h3>
		<span class="pull-left">route</span>
		<span><button class="btn btn-success" onclick="selectElementContents(document.getElementById('route_code'))" unselectable="on">تحديد الكود</button></span>
	</h3>
