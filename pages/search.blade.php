...
@section('content')
    ...
    {!! Form::open(['route' => '".strtolower($edited_table_name).".index','role'=>'form','class' => 'form-horizontal']) !!}

    @include('".strtolower($edited_table_name)."._form',['btnLabel' => 'بحث','formType' => 'create'])
...
<div class="clearfix col-xs-12">
    ...
    <h3>
        ...
        <span><button class="btn btn-success" onclick="selectElementContents(document.getElementById('create_code'))" unselectable="on">تحديد الكود</button></span>
