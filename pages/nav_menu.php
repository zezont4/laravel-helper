...
<li class='dropdown'>
	...
	<ul class='dropdown-menu' role='menu'>
		<li class='{{\$myForm->ifActive('" . strtolower($edited_table_name) . ".index')}}'><a href='{{route('" . strtolower($edited_table_name) . ".index')}}'>" . $edited_table_name . "s</a></li>
		<li class='{{\$myForm->ifActive('" . strtolower($edited_table_name) . ".create')}}'><a href='{{route('" . strtolower($edited_table_name) . ".create')}}'>جديد</a></li>
		<li class='{{\$myForm->ifActive('" . strtolower($edited_table_name) . ".search')}}'><a href='{{route('" . strtolower($edited_table_name) . ".search')}}'>بحث</a></li>
	</ul>
</li>"; ?>
